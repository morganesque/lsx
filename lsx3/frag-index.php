...
while(have_posts()): the_post();
    ...
    ?>
        <div class="index-item mod <?php echo $class; ?>">
            <?php if ($src): ?>
            ...
            <div class="meta">                
                ...
                if (!empty($cats))
                foreach ($cats as $c): ?>                    
                    <p class="cat bold mod" style="<?php echo doBack($c,0.22); ?>" ><a href="/<?php echo $c; ?>/"><?php echo $c; ?></a></p>
                <?php endforeach; ?>
                <p class="type bold" style="color:white; <?php echo doBack($type,0.11); ?>"><?php echo $type; ?></p>
            </div>            
            <div class="text">
                ...
                <div style="background-color:<?php echo ColourUtils::stringtorgba($cta.join('',$cats),0.22); ?>" class="readmore tk-museo-sans"><a href="<?php the_permalink(); ?>"><?php echo $cta; ?></a></div>                            
            </div><!-- .text -->            
