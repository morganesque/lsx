...
{
    echo '<div class="preh3"></div><h3 class="tk-tachyon">'.$title.'</h3>';
    ...
    foreach($upcoming->posts as $post)
    {
        ...
        ?>
            <a href="<?php echo get_permalink($post->ID) ?>" class="upcoming">                
                ...
                <p class="venue"><span style="color:<?php echo ColourUtils::stringtorgba($venue->post_title,0.42); ?>">@</span>&nbsp;<b><?php echo $venue->post_title; ?></b></p>  
            </a>
        <?php
    }
} else {
