...
function framework_discussion_title( $type = NULL, $echo = true ) {
	...
	if ( $number ) {
		$discussion_title  = '<'. $tag .' class="'. $type .'-title tk-tachyon">';
		$discussion_title .= '<span class="'. $type .'-title-meta">' . $number . ' on ' . '</span>';
