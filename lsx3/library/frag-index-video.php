...
while(have_posts()): the_post();
    ...
    ?>
        <div class="index-item mod video">
            <!-- <img src="<?php echo IMAGES; ?>/play.png" class="video-play"/> -->
            ...
            <div class="meta mod">                
                ...
                <?php endforeach; ?>
                <p class="duration bold" style="color:white; <?php echo doBackNum($vimeo['duration']['seconds'],7200,0.42); ?>">length: <?php echo $vimeo['duration']['nice'] ?></p>
                <p class="plays bold" style="color:white; <?php echo doBackNum($vimeo['stats_number_of_plays'],200,0.42); ?>">played: <?php echo $vimeo['stats_number_of_plays'] ?></p>
            </div>            
